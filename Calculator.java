...
Vector ViewToPoint = new Vector(x - ViewFrom[0], y - ViewFrom[1], z - ViewFrom[2]);
   ...
   // x = ViewFrom[0] + ViewToPoint.x ;
   // y = ViewFrom[1] + ViewToPoint.y ;
   // z = ViewFrom[2] + ViewToPoint.z ;
